...
function hasBeenMoreOneHour(date) {
    var HALF_HOUR = 1.8e6; // subtract for uncertainty
...
var regenerateSessionWithTokens = function (req, res, isRefresh, expressRes, hasTokens) {
...
var obtainTokensPromise = function (req, isRefresh, expressRes, hasTokens) { return __awaiter(void 0, void 0, void 0, function () {
    var tokenURL, headers, data, authCode, res;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, axios_1["default"].post(tokenURL, (0, qs_1.stringify)(data), headers)];
            case 1:
                res = _b.sent();
...
function hasTokens(req, res, next) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    if (!(((_a = req.session.user) === null || _a === void 0 ? void 0 : _a.access_token) && ((_b = req.session.user) === null || _b === void 0 ? void 0 : _b.refresh_token))) return [3 /*break*/, 4];
                    if (!hasBeenMoreOneHour(new Date(req.session.user.updateDate))) return [3 /*break*/, 2];
                    // refresh tokens
                    return [4 /*yield*/, obtainTokensPromise(req, true, res, true)["catch"](function (err) {
                            next(err);
                        })];
                case 1:
                    // refresh tokens
...
function refreshTokens(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, obtainTokensPromise(req, true, res)["catch"](function (err) {
                        next(err);
                    })];
                case 1:
                    _a.sent();
...
function obtainTokens(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, obtainTokensPromise(req, false, res)["catch"](function (err) {
                        next(err);
                    })];
                case 1:
                    _a.sent();

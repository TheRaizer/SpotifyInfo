...
const addEventListeners = (function () {
  ...
  function addDeleteRecentlyAddedTrackEvent () {
    function onClick () {
      ...
      if (
        numToRemove > selPlaylistTracks().size ||
         numToRemove === 0
      ) {
      ...
      const orderedTracks = manageTracks.orderTracksByDateAdded(
        selPlaylistTracks()
      )
      ...
      playlistActions.playlistSelVerif.currSelectedValNoNull.addToUndoStack(
        tracksToRemove
      )
        ...
        () => {
          ...
          if (
            ...
            playlistActions.showPlaylistTracks(
              playlistActions.playlistSelVerif.currSelectedValNoNull
            )
          }
        }
      )

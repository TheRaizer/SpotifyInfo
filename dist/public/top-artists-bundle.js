...
class SpotifyPlaybackElement {
    ...
    <article id="${config_1.config.CSS.IDs.webPlayer}" class="resize-drag">
      <img class="${config_1.config.CSS.CLASSES.column}" src="" alt="track" id="${config_1.config.CSS.IDs.playerTrackImg}"/>

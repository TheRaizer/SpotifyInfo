...
(0, config_1.addResizeDragAroundViewPort)('.resize-drag', 200, 120);
    ...
    (0, interactjs_1.default)(identifier)
        ...
        listeners: {
            move(evt) {
                ...
                if (newWidth === 100) {
                    // if the width should be the entire view port width then use this formula to exclude scroll bar
                    target.style.width = 'calc(100vw - (100vw - 100%));';
                }
                else {

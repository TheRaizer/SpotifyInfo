...
class SpotifyPlayback {
    ...
    tryPlayNext(currNode) {
        ...
        console.log((currNode.next !== null && (!this.wasInShuffle && exports.playerPublicVars.isShuffle)));
        if (!this.isExecutingAction) {

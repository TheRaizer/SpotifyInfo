...
class Slider {
    ...
    addTouchEvents() {
        ...
        (_a = this.sliderEl) === null || _a === void 0 ? void 0 : _a.addEventListener('touchstart', (evt) => {
            this.drag = true;
            config_1.resizeConfig.restrictResize = true;
            this.onDragStart();
        ...
        document.addEventListener('touchend', () => {
            config_1.resizeConfig.restrictResize = false;
            if (this.drag) {
...
exports.resizeConfig = { restrictResize: false };
function addResizeDrag(identifier, minWidth, minHeight) {
  ...
  "></div>`;
    ...
    (0, interactjs_1.default)(identifier)
        ...
        listeners: {
            move(evt) {
                if (exports.resizeConfig.restrictResize) {
                    return;
                }
                const target = evt.target;

...
class SpotifyPlayback {
    ...
    checkToShuffleIPlayables(playableToPushBefore = null) {
        if (exports.playerPublicVars.isShuffle && this.selPlaying.playableArr !== null && this.selPlaying.playableNode !== null) {
            console.log('shuffle');

...
class SpotifyPlaybackElement {
    ...
    updateBar(x, outerBar, innerBar, callback) {
        let percentage;
    ...
    assignEventListeners(playPrevFunc, pauseFunc, playNextFunc, volumeChangeFunc) {
        ...
        (_b = this.songProgress.sliderEl) === null || _b === void 0 ? void 0 : _b.addEventListener('mousedown', (ev) => {
            this.songProgress.drag = true;
            this.updateBar(ev.clientX, this.songProgress.sliderEl, this.songProgress.sliderProgress, () => { console.log('Update bar'); });
        });

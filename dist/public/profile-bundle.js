...
class SpotifyPlayback {
    ...
    onTrackFinish() {
        ...
        this.webPlayerEl.songProgress.value = '100';
...
class SpotifyPlaybackElement {
    ...
    <article id="${config_1.config.CSS.IDs.webPlayer}" class="resize-drag">
      ...
      <div id="${config_1.config.CSS.IDs.playTimeBar}">
        <p>0:00</p>
        <input id="${config_1.config.CSS.IDs.webPlayerProgress}" type="range" min="0" max="100" value="0" step="1"></input>
        <p>0:00</p>
      </div>
    </article>
    `;
     ...
     */
    updateElement(position, duration) {
        if (position !== 0) {
            this.songProgress.max = `${duration / 1000}`;
            this.songProgress.value = `${Math.round(position / 1000)}`;
    ...
    getWebPlayerEls() {
        ...
        this.songProgress = (_c = document.getElementById(config_1.config.CSS.IDs.webPlayerProgress)) !== null && _c !== void 0 ? _c : (0, config_1.throwExpression)('web player progress bar does not exist');

...
exports.addResizeDrag =
  exports.getPixelPosInElOnClick =
  exports.animationControl =
  exports.removeAllChildNodes =
  exports.getValidImage =
  exports.capitalizeFirstLetter =
  exports.isEllipsisActive =
  exports.getTextWidth =
  exports.searchUl =
  exports.promiseHandler =
  exports.htmlToEl =
  exports.millisToMinutesAndSeconds =
  exports.config =
    void 0;
...
function searchUl(ul, input, stdDisplay = "flex") {
  ...
  for (let i = 0; i < liEls.length; i++) {
    ...
    const name = liEls[i].getElementsByClassName(
      exports.config.CSS.CLASSES.name
    )[0];
